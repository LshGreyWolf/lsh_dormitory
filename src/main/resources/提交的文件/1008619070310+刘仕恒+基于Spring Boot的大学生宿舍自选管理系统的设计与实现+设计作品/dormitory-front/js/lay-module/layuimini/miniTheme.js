        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://www.hbwe.edu.cn/" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> 学校官网</a>\n' +
                    '<a class="more-menu-item" href="https://jiaowu.hbwe.edu.cn/" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 学校教务处</a>\n' +
                    '<a class="more-menu-item"  target="_blank"><i class="layui-icon layui-icon-theme"></i> 作者：刘仕恒</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
